...
DeBruijnTFactorr leverages graph neural networks to analyze protein sequences by modeling them as graphs based on their k-mer structures.
...
If you use DeBruijnTFactor in your research, please cite the following paper:
